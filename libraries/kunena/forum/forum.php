...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date  = ('2018-07-15' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2018-07-15';
		self::$version_name  = ('Charon' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Charon';
	}
